'''Contains core logic for othello game such as initialising board, printing board to console 
validates move according to rules'''
...
def initialise_board(size=8):
    ...
    y1=size//2
    y2=y1-1 
    #yeah could've just used x1 and x2 didn't need to make y variables
    #this is just so it's easier to understand for me
...
def legal_move(colour, coordinates, board_object):
    '''Checks if selected coordinates are legal for player to select'''
